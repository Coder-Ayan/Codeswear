        ...
        <section className="text-gray-600 body-font">
            <div className="container px-2 md:px-5 my-5 md:my-10 mx-auto">
                <div className="flex flex-wrap justify-center">
                    {Object.keys(products).length < 1 && <p className="text-center">Sorry, all stickers are currently out of stock. New stock coming soon. Stay tuned!</p>}
...
export async function getServerSideProps() {
    ...
    return { props: { products: stickers } }
}
